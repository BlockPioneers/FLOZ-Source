FLOZ 0.1.2
Copyright (c) 2014 FLOZ developers
...
About FLOZ
---------------
FLOZ is a FLOZ network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the FLOZ reference
wallet (http://github.com/FLOZ/FLOZ). 

To help faciliate broad community cooperation, a number of trusted 
FLOZ/Peershares community leaders have write permissions to the project's 
...
Resources
---------
FLOZ source code: https://github.com/FLOZ/FLOZ

For the most current instructions covering how to compile FLOZ from 
source on a variety of operating systems, please visit:
https://github.com/FLOZ/FLOZ/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/FLOZ/FLOZ/issues?state=open

FLOZ discussion forums (hosted by FLOZTalk.org): 
http://www.FLOZtalk.org/index.php?board=64.0



Acknowledgements
----------------
FLOZ owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	FLOZ (FLOZ) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	FLOZ is a free open source project with the goal of providing a 
