...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FLOZ");
    case mBTC: return QString("mFLOZ");
    case uBTC: return QString::fromUtf8("μFLOZ");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("FLOZ");
    case mBTC: return QString("Milli-FLOZ (1 / 1,000)");
    case uBTC: return QString("Micro-FLOZ (1 / 1,000,000)");
    default: return QString("???");
    }
}
