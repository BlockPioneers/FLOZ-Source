...
{
    resize(850, 550);
    setWindowTitle(tr("FLOZ Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/FLOZ_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    mintingAction = new QAction(QIcon(":/icons/stake"), tr("&Minting"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FLOZ address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/FLOZ_tooltip"), tr("&About FLOZ"), this);
    aboutAction->setToolTip(tr("Show information about FLOZ"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FLOZ"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/FLOZ_tooltip"), tr("Show/Hide &FLOZ"), this);
    toggleHideAction->setToolTip(tr("Show or hide the FLOZ window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/FLOZ_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/FLOZ_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/FLOZ_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FLOZ client"));
    trayIcon->setIcon(QIcon(":/icons/FLOZ_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FLOZ network", "", count));
}
