        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start FLOZ on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start FLOZ after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the FLOZ client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show FLOZ addresses in the transaction list"));
