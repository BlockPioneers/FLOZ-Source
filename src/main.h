...
static const int STAKE_TARGET_SPACING = 60;
static const int STAKE_MIN_AGE = 60 * 60 * 6;
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 100;
...
public:
    ...
    {
        // FLOZ: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // FLOZ: get transaction coin age
...
public:
    ...
    // FLOZ: block signature - signed by coin base txout[0]'s owner
    ...
    // FLOZ: two types of block: proof-of-work or proof-of-stake
    ...
    // FLOZ: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // FLOZ: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // FLOZ: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // FLOZ: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // FLOZ: block index flags
    enum  
    {
