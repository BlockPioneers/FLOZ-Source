...
// Copyright (c) 2012-2013 The FLOZ developers
...
// FLOZ version - intended for display purpose only
#define FLOZ_VERSION_MAJOR       1
#define FLOZ_VERSION_MINOR       0
#define FLOZ_VERSION_REVISION    0
#define FLOZ_VERSION_BUILD       0

static const int FLOZ_VERSION =
                           1000000 * FLOZ_VERSION_MAJOR
                         +   10000 * FLOZ_VERSION_MINOR
                         +     100 * FLOZ_VERSION_REVISION
                         +       1 * FLOZ_VERSION_BUILD;

// FLOZ version - reference for code tracking
